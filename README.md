...
When using RRPathGen with BunyipsLib, it's recommended you use this fork of the program.
The changes made here is that exported code will use the BunyipsLib method `makeTrajectory()`, 
